...
int main(int argc, char **argv){
    ...
    // Read initial data (Last step pre charging simulaitn)
    const string infileName2 = "../SRB_Precharge/SRB_Precharge.diff.out.hdf5";
	H5IO H5File_in2(infileName2, logger);
    modelDiff.ReadInitialCon(H5File_in2, 100);
