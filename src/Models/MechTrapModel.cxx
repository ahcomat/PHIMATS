...
MechTrapModel::MechTrapModel(vector<BaseElemTrap*> elements, H5IO& H5File_in){
...
MechTrapModel::~MechTrapModel(){
    ...
    PetscFinalize();
    // Exit message
    cout << "MechTrapModel model exited correctly" << "\n";
}

void MechTrapModel::setZero_nodFlux(){
...
void MechTrapModel::InitializePETSc(vector<BaseElemTrap*> elements){
...
void MechTrapModel::InitializeDirichBC(H5IO& H5File_in){
...
int MechTrapModel::get_nSteps() const{
    
    return nSteps;
}

Vec& MechTrapModel::getF(){

    return F;
}

Vec& MechTrapModel::getX(){

    return x;
}

Mat& MechTrapModel::getK(){

    return K_D;
}

// void MechTrapModel::CalcFlux(vector<BaseElemTrap*> elements, vector<BaseTrapping*> mats){
...
void MechTrapModel::WriteOut(vector<BaseElemTrap*> elements, H5IO &H5File_out, const string iStep){
