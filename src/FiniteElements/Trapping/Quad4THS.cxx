...
Quad4THS::Quad4THS(H5IO &H5File_in, Nodes &Nodes, int iSet)
...
Quad4THS::~Quad4THS(){
    ...
    // Exit message
    cout << "Quad4THS elements exited correctly" << "\n";
}

void Quad4THS::InitShapeFunc(){
...
RowVecd4 Quad4THS:: CalcShapeFunc(double xi, double eta){
...
Matd2x4 Quad4THS::CalcShapeFuncDeriv(double xi, double eta){
...
void Quad4THS::InitializeElements(Nodes &Nodes, H5IO &H5File_in){
    ...
    // Read nodal values of sigmaH
    nodSigmaH.resize(nNodes);
    string dsetName = "sigmaH";
    H5File_in.ReadFieldDoub1D(dsetName, nodSigmaH);      
    ...
    for(int iElem=0; iElem<nElements; iElem++){
        ...
        elSigmaH.at(iElem).resize(nElGauss);
...
RowVecd2 Quad4THS::getGaussCart(RowVecd4& sFunc, Matd4x2& elNodCoord){

    return sFunc*elNodCoord;  // N_i x_ij
}

void Quad4THS::CalcCartDeriv(Matd4x2& elNodCoord, Matd2x4& sFuncDeriv, const double& wt, double& intVol, Matd2x4& cartDeriv){
