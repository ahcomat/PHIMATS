...
void Quad4TH::CalcGrad(T_nodStres& nodGrad, vector<double>& nodCount){
...
void Quad4TH::CalcElemStiffMatx(BaseTrapping* mat, double T){
...
void Quad4TH::CalcFlux(T_DMatx KMatx, const double* globalBuffer, T_nodStres& nodFlux, vector<double>& nodCount){
