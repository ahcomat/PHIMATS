 ...
 * @brief Class for managing Quad4Axi elements. 
 * @date 2026-02-09
 * 
...
class Quad4Axi: public BaseElemMech{

public:

Quad4Axi(H5IO &H5File_in, H5IO &H5File_mesh, Nodes &Nodes, int iSet, string matModel, Logger& logger);   
